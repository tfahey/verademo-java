...
If you don't already have Docker this is a prerequisite.
	...
	docker run -p 8080:8080 kevinrise/vulnerable-verademo-java

Navigate to: `http://127.0.0.1:8080`, register as a new user, login, add some feeds and blabs.

## Other Notes

The source for this image is hosted [here](https://github.com/veracode-demo-labs/verademo-java), and within that repo are additional files that will cover both how to exploit this application and build this application for various CI systems.
